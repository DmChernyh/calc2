...
//        calc(inputStr);
    ...
    public static String calc(String inputStr) throws IOException {
        ...
        String inputStrReturn2 = inputStrReturn.replaceAll("\\s",""); //удаление пробелов
        ...
        if((Objects.equals(afterSplit[0],"1") || Objects.equals(afterSplit[0],"2")
            ...
            if(result < 1){
                ...
                throw new IOException("хотя бы один из операндов не соответствует диапазону от 1 до 10");
        }
        return resultStr;
    }
}
